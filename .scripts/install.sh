...
sudo pacman -S git man base-devel pacman-contrib arandr vim neovim htop fastfetch dmenu ranger nitrogen dunst telegram-desktop spectacle mpv feh nodejs npm unzip ripgrep fd xclip python-pywal --noconfirm || exit 1
